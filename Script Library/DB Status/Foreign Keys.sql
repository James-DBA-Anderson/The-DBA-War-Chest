...
-- DBA War Chest 
-- Show the state of all foreign keys
-- 2016-02-15

-- Display the state of all foreign keys with their supported indexes.
-- This script comes from this Steve Hood blog post: http://www.sqlservercentral.com/articles/foreign+keys/136445/
...
--ORDER BY 1
ORDER BY is_disabled, is_not_trusted, 1
