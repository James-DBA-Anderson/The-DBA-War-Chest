...
CREATE TABLE #WaitsToIgnore(WaitType SYSNAME PRIMARY KEY);
 
INSERT #WaitsToIgnore(WaitType) VALUES(N'BROKER_EVENTHANDLER'),
...
(
  ...
  WHERE [wait_type] NOT IN (SELECT WaitType FROM #WaitsToIgnore)
